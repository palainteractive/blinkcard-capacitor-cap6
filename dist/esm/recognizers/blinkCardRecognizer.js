...
import { Date, BlinkCardAnonymizationSettings, ImageExtensionFactors, } from '../types';
...
export class BlinkCardRecognizer extends Recognizer {
    constructor() {
         ...
         *
         */
        this.photocopyAnalysisMatchLevel = 5 /* BlinkCardMatchLevel.Level5 */;
        /**
         ...
         *
         */
        this.screenAnalysisMatchLevel = 5 /* BlinkCardMatchLevel.Level5 */;
        this.createResultFromNative = (nativeResult) => { return new BlinkCardRecognizerResult(nativeResult); };
    }
}
//# sourceMappingURL=blinkCardRecognizer.js.map